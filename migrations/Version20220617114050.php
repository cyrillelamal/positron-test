 ...
 */
final class Version20220617114050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(511) NOT NULL, isbn VARCHAR(13) DEFAULT NULL, page_count INT NOT NULL, published_date DATE DEFAULT NULL, thumbnail_url JSON DEFAULT NULL, short_description LONGTEXT DEFAULT NULL, long_description LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, updated_at DATE DEFAULT NULL, UNIQUE INDEX book_isbn (isbn), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
